...
def evaluate_analog(
    ...
    if exe_name == "online_ed":
        with open("./data_online_ed_analog/transform.pk", "rb") as f:
            _, cont_cols, saved_cat_dict = pickle.load(f)
...
def evaluate_onehot(
    ...
    if exe_name == "online_ed":
        with open("./data_online_ed_onehot/transformed_columns.pk", "rb") as f:
            cont_cols, saved_cat_dict = pickle.load(f)
        print(cont_cols, saved_cat_dict)
        with open("./data_online_ed_onehot/encoder.pk", "rb") as f:
            encoder = pickle.load(f)
    print(cont_cols, saved_cat_dict)
    torch.manual_seed(0)
    np.random.seed(0)
...
def evaluate_ft(
    ...
    if exe_name == "online_ed":
        with open("./data_online_ed_ft_MI/transformed_columns.pk", "rb") as f:
            cont_list, num_cate_list = pickle.load(f)
        with open("./data_online_ed_ft/encoder.pk", "rb") as f:
            encoder = pickle.load(f)

    if exe_name == "crime":
        with open("./data_crime_ft_MI/transformed_columns.pk", "rb") as f:
            cont_list, num_cate_list = pickle.load(f)
        with open("./data_crime_ft_MI/encoder.pk", "rb") as f:
            encoder = pickle.load(f)
