...
from testing_breast_real import get_dataloader
...
foldername = "./save/breast_2_train_testing_fold" + str(args.nfold) + "_" + current_time + "/"
...
model.load_state_dict(torch.load("./save/" +"breast_2_train_testing_fold" + str(args.nfold) + "_" + current_time + "/model.pth"))
print("---------------Start testing---------------")
