...
from src.utils_table import evaluate_ft
from testing_online_ed_real import get_dataloader

parser = argparse.ArgumentParser(description="TabCSDI")
parser.add_argument("--config", type=str, default="online_ed_ft.yaml")
...
foldername = "./save/online_ed_2_train_testing_fold" + str(args.nfold) + "_" + current_time + "/"
