...
data = pd.read_csv('./Linear Regression/datasets/CommunitiesAndCrime.csv')
...
results_df.to_csv('./Linear Regression/results/communitiesAndCrimeResults.csv', index=False)
...
baseline_results_df.to_csv('./Linear Regression/results/communitiesResultsBaseline.csv', index=False)
